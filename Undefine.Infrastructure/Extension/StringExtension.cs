...
namespace Undefine.Infrastructure.Extension
{
    ...
    public static class StringExtension
    {
        ...
        #region 相等判断
        public static bool IsEq(this string inputStr, string eqStr)
        {
            if (eqStr.IsNotNull())
            {
                return inputStr.Equals(eqStr);
            }
            else
            {
                return false;
        ...
        //{
        //    //return ConfigurationManager.ConnectionStrings[inputStr].IsNull() ? null : ConfigurationManager.ConnectionStrings[inputStr].ConnectionString;
        //}
        ...
        /// <param name="inputStr"></param>
        /// <returns></returns>
        //public static void SaveAppSetting(this string inputStr, string Value)
        //{
        //    //Configuration config = ConfigurationManager.OpenExeConfiguration(ConfigurationUserLevel.None);
        //    //config.AppSettings.Settings[inputStr].Value = Value;
